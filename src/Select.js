...
const Select = React.createClass({
	...
	propTypes: {
		...
		onSelectionFocus: React.PropTypes.func,    // OPENGOV ADDED THIS PROP. Allows us to highlight columns in mappingwizzard. onSelectionFocus handler: function (event) {}
